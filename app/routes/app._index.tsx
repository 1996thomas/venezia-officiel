...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const [referrerSummaries, recentReferralsRaw, rewardStats, referralStats, totalReferrers, settings] =
    await Promise.all([
      listReferrersWithStats(10),
  ...
  const referrers = referrerSummaries.map((summary) => ({
    id: summary.id,
    name: summary.name,
